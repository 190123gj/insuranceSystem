...
public class PriceContactLetterDemandOrder extends ProcessOrder {
	...
	private List<PriceContactLetterDemandDetailOrder> detailOrders;
	
	private List<PriceContactLetterDemandDetailTwoOrder> detailTwoOrders;

	private PriceContactLetterSchemeOrder schemeOrder;

	private List<PriceContactLetterAskCompanyOrder> askCompanyOrders;
	...
	public List<PriceContactLetterDemandDetailOrder> getDetailOrders() {
		return detailOrders;
	}

	public void setDetailOrders(List<PriceContactLetterDemandDetailOrder> detailOrders) {
		this.detailOrders = detailOrders;
	}

	public List<PriceContactLetterDemandDetailTwoOrder> getDetailTwoOrders() {
		return detailTwoOrders;
	}

	public void setDetailTwoOrders(List<PriceContactLetterDemandDetailTwoOrder> detailTwoOrders) {
		this.detailTwoOrders = detailTwoOrders;
	}

	public PriceContactLetterSchemeOrder getSchemeOrder() {
		return schemeOrder;
	}

	public void setSchemeOrder(PriceContactLetterSchemeOrder schemeOrder) {
		this.schemeOrder = schemeOrder;
	}

	public List<PriceContactLetterAskCompanyOrder> getAskCompanyOrders() {
		return askCompanyOrders;
	}

	public void setAskCompanyOrders(List<PriceContactLetterAskCompanyOrder> askCompanyOrders) {
		this.askCompanyOrders = askCompanyOrders;
	}
