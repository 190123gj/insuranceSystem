package com.born.insurance.ws.info.priceContactLetterScheme;
...
public class PriceContactLetterSchemeInfo extends BaseToStringInfo {
	...
	*/	
	...
	private List<PriceContactLetterSchemeDetailInfo> schemeDetailInfoList;
	...
	public List<PriceContactLetterSchemeDetailInfo> getSchemeDetailInfoList() {
		return schemeDetailInfoList;
	}

	public void setSchemeDetailInfoList(List<PriceContactLetterSchemeDetailInfo> schemeDetailInfoList) {
		this.schemeDetailInfoList = schemeDetailInfoList;
	}
