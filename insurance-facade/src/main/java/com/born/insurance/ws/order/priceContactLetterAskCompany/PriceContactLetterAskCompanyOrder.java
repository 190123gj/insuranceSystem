package com.born.insurance.ws.order.priceContactLetterAskCompany;
...
/**
 * Created by wqh on 2017-2-22.
 */
public class PriceContactLetterAskCompanyOrder extends ProcessOrder {
    private long id;
