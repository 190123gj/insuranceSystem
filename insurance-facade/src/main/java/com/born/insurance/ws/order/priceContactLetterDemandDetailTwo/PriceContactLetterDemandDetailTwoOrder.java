...
public class PriceContactLetterDemandDetailTwoOrder extends ProcessOrder {
	...
	* 初次登记日期
	*/	
	private String initialRegistrationString;
 	/**
	* 船舶类型
	*/	
	...
	* 改建日期
	*/	
	private String alterationString;
	...
	public void setConstructionString(String constructionString) {
	...
	public String getInitialRegistrationString() {
        return initialRegistrationString;
	}

	public void setInitialRegistrationString(String initialRegistrationString) {
        this.initialRegistrationString = initialRegistrationString;
	}
	...
	public String getAlterationString() {
        return alterationString;
	}

	public void setAlterationString(String alterationString) {
        this.alterationString = alterationString;
	}
