...
public class CustomerCompanyInfo extends CustomerBaseInfo{
	...
	private List<ValueTaxInfo> taxInfos;
	...
	public List<ValueTaxInfo> getTaxInfos() {
		return taxInfos;
	}

	public void setTaxInfos(List<ValueTaxInfo> taxInfos) {
