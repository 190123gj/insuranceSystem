...
@Controller
@RequestMapping("/insurance/customer/company")
public class CustomerCompanyController extends CompanyBaseController {
	

	private final String VM_PATH = "/insurance/customerManage/company/";
	...
	public String list(HttpServletRequest request, HttpServletResponse response, Model model) {
		try {
			queryList(request, model, CustomerTypeEnum.COMPANY_CUSTOMER);
		} catch (Exception e) {
			logger.error("企业客户", e);
		}
		return VM_PATH + "listCompany.vm";
	}
