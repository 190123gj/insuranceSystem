package com.born.insurance.web.controller.settlement;
...
public class SettlementHomeController extends BaseController {
	

	final static String vm_path = "/insurance/settlement/";
