...
import com.born.insurance.dal.daointerface.CustomerRelationApplyDAO;
...
/**
 * An ibatis based implementation of dao interface <tt>com.born.insurance.dal.daointerface.CustomerRelationApplyDAO</tt>.
 *
...
public class IbatisCustomerRelationApplyDAO extends SqlMapClientDaoSupport implements CustomerRelationApplyDAO {
	/**
    ...
    public long insert(CustomerRelationApplyDO customerRelationApply) throws DataAccessException {
    	if (customerRelationApply == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-CUSTOMER-RELATION-APPLY-INSERT", customerRelationApply);

        return customerRelationApply.getApplyRelationId();
    }
    ...
    public int update(CustomerRelationApplyDO customerRelationApply) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-CUSTOMER-RELATION-APPLY-UPDATE", customerRelationApply);
    }
    ...
    public CustomerRelationApplyDO findById(long applyRelationId) throws DataAccessException {
        Long param = new Long(applyRelationId);

        return (CustomerRelationApplyDO) getSqlMapClientTemplate().queryForObject("MS-CUSTOMER-RELATION-APPLY-FIND-BY-ID", param);
    ...
    public int deleteById(long applyRelationId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-CUSTOMER-RELATION-APPLY-DELETE-BY-ID", param);
    }
    ...
    public List<CustomerRelationApplyDO> findByCondition(CustomerRelationApplyDO customerRelationApply, String sortCol, String sortOrder, long limitStart, long pageSize) throws DataAccessException {
        ...
        param.put("customerRelationApply", customerRelationApply);
        param.put("sortCol", sortCol);
        param.put("sortOrder", sortOrder);
        param.put("limitStart", new Long(limitStart));
        param.put("pageSize", new Long(pageSize));

        return getSqlMapClientTemplate().queryForList("MS-CUSTOMER-RELATION-APPLY-FIND-BY-CONDITION", param);
    ...
    public long findByConditionCount(CustomerRelationApplyDO customerRelationApply) throws DataAccessException {
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-CUSTOMER-RELATION-APPLY-FIND-BY-CONDITION-COUNT", customerRelationApply);
