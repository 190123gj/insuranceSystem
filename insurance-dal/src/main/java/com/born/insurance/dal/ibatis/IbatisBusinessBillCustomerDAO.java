...
/**
 * An ibatis based implementation of dao interface <tt>com.born.insurance.dal.daointerface.BusinessBillCustomerDAO</tt>.
 *
...
public class IbatisBusinessBillCustomerDAO extends SqlMapClientDaoSupport implements BusinessBillCustomerDAO {
	/**
    ...
    public long insert(BusinessBillCustomerDO businessBillCustomer) throws DataAccessException {
    	if (businessBillCustomer == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-BUSINESS-BILL-CUSTOMER-INSERT", businessBillCustomer);

        return businessBillCustomer.getBillCustomerId();
    }
    ...
    public int update(BusinessBillCustomerDO businessBillCustomer) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-BUSINESS-BILL-CUSTOMER-UPDATE", businessBillCustomer);
    }
    ...
    public BusinessBillCustomerDO findById(long billCustomerId) throws DataAccessException {
        ...
        return (BusinessBillCustomerDO) getSqlMapClientTemplate().queryForObject("MS-BUSINESS-BILL-CUSTOMER-FIND-BY-ID", param);
    ...
    public int deleteById(long billCustomerId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-BUSINESS-BILL-CUSTOMER-DELETE-BY-ID", param);
    }
    ...
    public List<BusinessBillCustomerDO> findByCondition(BusinessBillCustomerDO businessBillCustomer, String sortCol, String sortOrder, long limitStart, long pageSize) throws DataAccessException {
        ...
        param.put("businessBillCustomer", businessBillCustomer);
        param.put("sortCol", sortCol);
        param.put("sortOrder", sortOrder);
        param.put("limitStart", new Long(limitStart));
        param.put("pageSize", new Long(pageSize));

        return getSqlMapClientTemplate().queryForList("MS-BUSINESS-BILL-CUSTOMER-FIND-BY-CONDITION", param);
    ...
    public long findByConditionCount(BusinessBillCustomerDO businessBillCustomer) throws DataAccessException {
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-BUSINESS-BILL-CUSTOMER-FIND-BY-CONDITION-COUNT", businessBillCustomer);
    ...
    public List<BusinessBillCustomerDO> findBusinessBillCustomers(String billNo) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-BUSINESS-BILL-CUSTOMER-FIND-BUSINESS-BILL-CUSTOMERS", billNo);
    ...
    public BusinessBillCustomerDO findBillCustomerInfo(long businessBillId, String type) throws DataAccessException {
        ...
        return (BusinessBillCustomerDO) getSqlMapClientTemplate().queryForObject("MS-BUSINESS-BILL-CUSTOMER-FIND-BILL-CUSTOMER-INFO", param);
