...
/**
 * An ibatis based implementation of dao interface <tt>com.born.insurance.dal.daointerface.ProjectSetupDAO</tt>.
 *
...
public class IbatisProjectSetupDAO extends SqlMapClientDaoSupport implements ProjectSetupDAO {
	/**
    ...
    public long insert(ProjectSetupDO projectSetup) throws DataAccessException {
        ...
        getSqlMapClientTemplate().insert("MS-PROJECT-SETUP-INSERT", projectSetup);

        return projectSetup.getProjectSetupId();
    }
    ...
    public int update(ProjectSetupDO projectSetup) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-PROJECT-SETUP-UPDATE", projectSetup);
    }
    ...
    public ProjectSetupDO findById(long projectSetupId) throws DataAccessException {
        ...
        return (ProjectSetupDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-SETUP-FIND-BY-ID", param);
    ...
    public ProjectSetupDO findByFormId(long formId) throws DataAccessException {
        ...
        return (ProjectSetupDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-SETUP-FIND-BY-FORM-ID", param);
    ...
    public int deleteById(long projectSetupId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-PROJECT-SETUP-DELETE-BY-ID", param);
    }
    ...
    public List<ProjectSetupDO> findByCondition(ProjectSetupDO projectSetup, String sortCol, String sortOrder, long limitStart, long pageSize) throws DataAccessException {
        ...
        param.put("projectSetup", projectSetup);
        param.put("sortCol", sortCol);
        param.put("sortOrder", sortOrder);
        param.put("limitStart", new Long(limitStart));
        param.put("pageSize", new Long(pageSize));

        return getSqlMapClientTemplate().queryForList("MS-PROJECT-SETUP-FIND-BY-CONDITION", param);
    ...
    public long findByConditionCount(ProjectSetupDO projectSetup) throws DataAccessException {
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-PROJECT-SETUP-FIND-BY-CONDITION-COUNT", projectSetup);
