        ...
        */
        ...
        __Sdk_MenuCommandCtl: function(_action, _winObj, _customMenus /*, bRedraw */ ) {
            try {
                ...
                if (typeof _winObj == "undefined" || typeof _winObj.wnd == "undefined" || typeof _winObj.wnd["NPP_b_MENU_COMMAND"] == "undefined" || !_winObj.wnd["NPP_b_MENU_COMMAND"]) {
                ...
                switch (action) {
                    case "cloud": // - 下载平台录像或图片
                        ...
                        if (_dlhash.get(options.connectId)) {
                            ...
                            if (_dlCSUFileStore.containsKey(_dlkey)) {
                                // - 判断是否存在同一下载通道
                                if (typeof _dlCSUFileStore.get(_dlkey).dlStreamHandle != "undefined" && _dlCSUFileStore.get(_dlkey).dlStreamHandle != null) {
                    ...
                    case "dlcefsvod": // - 下载CEFS录像
                        ...
                        if (_dlhash.get(options.connectId)) {
                            ...
                            if (_dlCEFSVodFileStore.containsKey(_dlkey)) {
                                // - 判断是否存在同一下载通道
                                if (typeof _dlCEFSVodFileStore.get(_dlkey).dlStreamHandle != "undefined" && _dlCEFSVodFileStore.get(_dlkey).dlStreamHandle != null) {
                                    P_Utils.Log(fn, "cefs vod dl existed, dlkey->" + _dlkey);
                                    return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR_DOWNLOAD_EXISTED, _dlCEFSVodFileStore.get(_dlkey).dlStreamHandle);
                                }
                            }
                    ...
                    case "dlcefsimage": // - 下载CEFS图片
                        ...
                        if (_dlhash.get(options.connectId)) {
                            ...
                            if (_dlCEFSImageFileStore.containsKey(_dlkey)) {
                                // - 判断是否存在同一下载通道
                                if (typeof _dlCEFSImageFileStore.get(_dlkey).dlStreamHandle != "undefined" && _dlCEFSImageFileStore.get(_dlkey).dlStreamHandle != null) {
    ...
    Enum: {
        ...
        */
        ...
        CEFSRecordReasonDesc: {
            ...
            "LinkAction(AlertIn)": {
                "zh_CN": "联动录像（发生报警）",
                "en": "LinkAction video(Alarm)"
            },
            "LinkAction(MotionDetected)": {
                "zh_CN": "联动录像（侦测到移动）",
                "en": "LinkAction video(Motion Detected)"
            },
            "LinkAction(SignalLost)": {
                "zh_CN": "联动录像（视频信号丢失）",
                "en": "LinkAction video(Signal Lost)"
            }
        },
        // - CEFS抓拍原因
        CEFSPictureReason: {
        ...
        CEFSPictureReasonDesc: {
            ...
            "LinkAction(AlertIn)": {
                "zh_CN": "联动抓拍（发生报警）",
                "en": "LinkAction snapshot(Alarm)"
            },
            "LinkAction(MotionDetected)": {
                "zh_CN": "联动抓拍（侦测到移动）",
                "en": "LinkAction snapshot(Motion Detected)"
            },
            "LinkAction(SignalLost)": {
                "zh_CN": "联动抓拍（视频信号丢失）",
                "en": "LinkAction snapshot(Signal Lost)"
            }
        },
        // CEFS用户日志类型
        CEFSUserLogType: {
        ...
        CEFSUserLogTypeDesc: {
            ...
            OpenDoor: {
                "zh_CN": "打开挡板",
                "en": "Open Baffle plate"
            },
            CloseDoor: {
                "zh_CN": "关闭挡板",
                "en": "Close Baffle plate"
            },
            PowerOff: {
                "zh_CN": "系统关机",
                "en": "System Power Off"
